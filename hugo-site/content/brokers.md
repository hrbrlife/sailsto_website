...
<section class="page-hero" style="background: var(--navy);">
    ...
    <div class="hero-ctas">
        <a href="/signup/?type=broker" class="btn-hero primary">Apply to Join Network</a>
        <a href="/pricing/" class="btn-hero secondary">View Commission Structure</a>
    </div>
