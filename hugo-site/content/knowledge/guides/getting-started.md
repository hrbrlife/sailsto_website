    ...
    <main class="guide-content">
        <div class="guide-container">
            ...
            <section id="overview" class="guide-section">
                ...
                <p>Sails.to is a compliant platform for issuing, investing in, and distributing <span class="glossary-term" data-term="security-token">security tokens</span>. We combine blockchain efficiency with traditional finance compliance to offer the best of both worlds.</p>
                <h3>What We Offer</h3>
                <ul>
            ...
            <section id="brokers" class="guide-section">
                ...
                <div class="step-card">
                    ...
                    <div class="step-content">
                        ...
                        <p>Sign up at <a href="../../signup.html?type=broker">sails.to/signup</a> and select "Broker." Provide your firm details and regulatory status.</p>
                    </div>
                </div>
                <div class="step-card">
                    <div class="step-number">2</div>
            ...
            <section id="support" class="guide-section">
                ...
                <ul>
                    <li><strong>Email:</strong> support@sails.to</li>
