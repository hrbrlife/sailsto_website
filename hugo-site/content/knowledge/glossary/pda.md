...
<header class="term-page-header">
    <div class="container">
        ...
        <h1 class="term-title">PDA (Program Derived Address)</h1>
        <p class="term-short">A deterministic Solana account address derived from program seeds, used in Sails.to for trustless, programmatic state management.</p>
    </div>
</header>
<main class="term-content">
    <div class="term-content-inner">
        ...
        <div class="term-cta">
            <h3>State you can verify</h3>
            <p>Deterministic addresses. Program-controlled data. Zero trust required.</p>
