...
<header class="term-page-header">
    <div class="container">
        ...
        <h1 class="term-title">Sails CrossSecurities</h1>
        <p class="term-short">Securities that can be held on-chain or via traditional bank/brokerage custody — and crossed from one form to another at will.</p>
    </div>
</header>
<main class="term-content">
    <div class="term-content-inner">
        <section class="term-section">
            ...
            <p><strong>Sails CrossSecurities</strong> are bonds, shares, or RWA (Real World Asset) tokens issued on the Sails.to platform that exist in a unique dual-format structure. They can be held either:</p>
            <ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Solana token address</td>
                        <td>ISIN code</td>
                    </tr>
                    <tr>
                        <td><strong>Custody</strong></td>
                        <td>Self-custody or qualified custodian</td>
                        <td>Bank/brokerage via Clearstream</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>24/7 OTC network</td>
                        <td>Bank hours, Vienna MTF optional</td>
                    </tr>
                    <tr>
                        <td><strong>Conversion</strong></td>
                        <td>Cross to bankable: ~0.75% fee</td>
                        <td>Cross to on-chain: ~0.75% fee</td>
                    </tr>
                </tbody>
            </table>
        </section>
        ...
        <div class="term-cta">
            <h3>Securities that cross the line</h3>
            <p>Hold on-chain or through your bank. Cross between forms at will.</p>
