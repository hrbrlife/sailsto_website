...
<header class="term-page-header">
    <div class="container">
        ...
        <h1 class="term-title">TradFi Bridge (CrossConversion)</h1>
        <p class="term-short">Also known as <a href="/knowledge/glossary/crossconversion/">CrossConversion</a> — Sails.to's mechanism for converting on-chain CrossSecurities to bankable ISIN securities.</p>
    </div>
</header>
<main class="term-content">
    <div class="term-content-inner">
        <section class="term-section">
            ...
            <p>The TradFi (Traditional Finance) Bridge, now called <strong>CrossConversion</strong>, is a unique feature of Sails.to that allows investors to move <a href="/knowledge/glossary/crosssecurities/">CrossSecurities</a> between on-chain and bankable forms. Tokens held on Solana can be "crossed" to receive an ISIN and be settled through Clearstream, appearing in the investor's regular brokerage account. Conversely, bankable ISIN-held securities can be crossed back to on-chain tokens. This is what makes CrossSecurities truly hybrid.</p>
        </section>
        <section class="term-section">
        ...
        <div class="term-cta">
            ...
            <p>On-chain innovation meets bankable infrastructure.</p>
