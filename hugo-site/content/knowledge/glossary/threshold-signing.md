...
<header class="term-page-header">
    <div class="container">
        ...
        <h1 class="term-title">Threshold Signing</h1>
        <p class="term-short">M-of-N keyholder cryptographic operations used to protect critical Sails.to platform actions, implementing distributed authority on Solana.</p>
    </div>
</header>
<main class="term-content">
    <div class="term-content-inner">
        ...
        <div class="term-cta">
            ...
            <p>Distributed authority. Independent keyholders. Mathematical guarantees.</p>
