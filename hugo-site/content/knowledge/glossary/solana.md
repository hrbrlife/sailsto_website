...
description: "A high-performance blockchain platform known for fast transaction speeds (400ms finality) and low fees, used by Sails.to for issuing security tokens."
stylesheets:
    ...
    <main class="term-content">
        <div class="term-content-inner">
            ...
            <div class="term-cta">
                ...
                <p>Fast, cheap, and institutional-ready.</p>
                <a href="../../signup.html?type=issuer" class="btn">Launch on Solana</a>
            </div>
        </div>
    </main>
