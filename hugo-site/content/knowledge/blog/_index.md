...
<section class="blog-content" style="max-width:900px;margin:3rem auto;padding:0 1.5rem;">
    <div class="coming-soon-notice" style="text-align:center;padding:4rem 2rem;background:var(--bg-primary);border-radius:12px;border:1px solid rgba(0,0,0,0.06);">
        ...
        <h2 style="font-family:var(--font-display);margin:1rem 0 0.5rem;">In Development</h2>
        <p style="color:var(--text-secondary);max-width:480px;margin:0 auto 1.5rem;">We're preparing articles on CrossSecurities, regulatory frameworks, and the DeFi-TradFi bridge. Check back soon.</p>
