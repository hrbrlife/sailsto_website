...
<section class="page-hero" style="background: linear-gradient(135deg, var(--navy) 0%, var(--charcoal) 100%);">
    ...
    <div class="hero-ctas">
        <a href="/signup/?type=investor" class="btn-hero primary">Access Deal Flow</a>
        <a href="/whatsails/" class="btn-hero secondary">Learn How It Works</a>
    </div>
    ...
    <div class="detail-container">
        <div class="detail-grid">
            <div class="detail-content">
                ...
                <p>Every offering on the platform comes with comprehensive disclosures, verified issuer information, and clear governance. No anonymous projects. No undisclosed risks.</p>
                <p>Browse debt, equity, and revenue-share instruments from established businesses seeking growth capital. Filter by asset type, geography, minimum investment, expected returns.</p>
            </div>
            <ul class="detail-list">
                <li>
                    ...
                    <div class="text">
                        ...
                        <p>Offering memorandums, financials, risk factors, use of proceeds. All available before you invest.</p>
                    </div>
                </li>
                <li>
    ...
    <div class="detail-container">
        <div class="detail-grid">
            <div class="detail-content">
                ...
                <p>Trade within a verified universe of eligible investors. Access OTC liquidity through the broker network when you need broader routing.</p>
                <p>All trades enforce eligibility at the protocol level. No accidental transfers to ineligible parties. Clean audit trails throughout.</p>
            </div>
            <ul class="detail-list">
                <li>
                    <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" /></svg></span>
                ...
                <li>
                    ...
                    <div class="text">
                        <h4>Broker Network</h4>
                        <p>Access broader liquidity through licensed brokers. Cross-broker routing when needed.</p>
                    </div>
                </li>
                <li>
    ...
    <div class="detail-container">
        <div class="detail-grid">
            <div class="detail-content">
                ...
                <p>Investor eligibility is verified once and enforced everywhere. Accreditation status, jurisdiction, holding limits: all checked at the protocol level before any transaction executes.</p>
                <p>Transfer restrictions follow the security, not the venue. Same compliance whether you hold on-chain or through traditional custody.</p>
            </div>
            <ul class="detail-list">
                <li>
                ...
                <li>
                    ...
                    <div class="text">
                        <h4>Audit Trail</h4>
                        <p>Every transaction recorded. Export for your records, your accountant, your auditor.</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="features-container">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <h3>Deal Discovery</h3>
                <p>Browse active offerings with full disclosure documents. Filter by type, geography, returns, minimum investment.</p>
            </div>
            <div class="feature-card">
                <span class="feature-icon">📊</span>
            ...
            <div class="feature-card">
                ...
                <p>Offering documents, subscription confirmations, distribution notices. All in your document vault.</p>
            </div>
            <div class="feature-card">
                <span class="feature-icon">💰</span>
                <h3>Distribution Tracking</h3>
                <p>See scheduled distributions, track received payments, export for tax reporting.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="global-card">
            ...
            <div class="global-stats">
                ...
                <div class="global-stat">
                    ...
                    <div class="label">Bank custody</div>
                </div>
            </div>
        </div>
    </div>
...
<section class="cta-section">
    ...
    <p>Professional investors can browse offerings after verification.</p>
    <a href="/signup/?type=investor" class="btn btn-primary">
        Create Account
