...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  <symbol id="icon-scan" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
  </symbol>
  <symbol id="icon-clipboard" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
  ...
  <symbol id="icon-landmark" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    ...
    <div class="trust-section">
        ...
        <div class="trust-grid">
            <div class="trust-item active">
                <span class="icon-wrapper small"><svg><use href="#icon-scan"></use></svg></span>
                <span class="trust-text">Audited</span>
            </div>
            <div class="trust-item active">
                <span class="icon-wrapper small"><svg><use href="#icon-clipboard"></use></svg></span>
...
<div class="card-content">
    ...
    <div class="trust-section">
        ...
        <div class="trust-grid">
            ...
            <div class="trust-item active">
                <span class="icon-wrapper small"><svg><use href="#icon-clipboard"></use></svg></span>
                <span class="trust-text">Big Four</span>
            </div>
            <div class="trust-item active">
                <span class="icon-wrapper small"><svg><use href="#icon-document"></use></svg></span>
                <span class="trust-text">PPM</span>
            ...
            <div class="trust-item active">
                <span class="icon-wrapper small"><svg><use href="#icon-landmark"></use></svg></span>
                <span class="trust-text">EU-GMP</span>
            </div>
        </div>
    </div>
    <span class="flip-hint">↻ Hover for details</span>
    ...
    <div class="trust-section">
        ...
        <div class="trust-grid">
            ...
            <div class="trust-item active">
                ...
                <span class="trust-text">EU Grant</span>
            </div>
        </div>
    </div>
    <span class="flip-hint">↻ Hover for details</span>
