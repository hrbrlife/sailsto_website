    ...
    "aitxpro": {
        **DEFAULT_TERM_RULES,
        "AiTX.pro": ["AITX.pro", "aitx.pro", "Aitx.pro", "AiTx.pro",
                      ...
                      "AiTX Pro", "AiTX.Pro"],
        "AiTX.pro Limited": ["AiTX.pro Ltd", "AiTX Ltd", "AITX.pro Limited",
                              "aitx.pro limited"],
        ...
        "Full-Service Dealer, excluding Underwriting": [
            "full service dealer", "full-service broker",
            "Full Service Dealer", "full service dealer excluding underwriting"],
        "Securities Act 2005": ["Securities Act", "securities act 2005",
                                 "SA 2005"],
        "B2B Prime Services EU Ltd": ["B2B Prime", "b2b prime", "B2B prime",
                                       "B2B Prime Services", "b2b prime services eu",
                                       "B2BPRIME"],
        "JurisTax Ltd": ["Juristax", "juristax", "juritax", "Juritax",
                          "JURISTAX"],
        "BankOne Ltd": ["Bank One", "BANKONE", "bankone", "Bank one"],
        "MAU Bank Ltd": ["Mau Bank", "mau bank", "MAU BANK", "Maubank"],
        "Mauritius": ["mauritius", "MAURITIUS"],
        "segregated accounts": ["pooled funds", "commingled funds",
                                 "insured funds"],
        "professional investor": ["retail investor", "general public",
                                   "anyone can invest", "retail trader"],
    },
}
...
CANONICAL_NUMBERS: dict[str, list[str]] = {
    ...
    "aitxpro": {
        ...
        "202414": ["Company No.", "company registration", "registration number"],
        "370/18": ["CySEC licence", "B2B Prime licence", "LP licence"],
        "357630": ["B2B Prime registration", "LP registration number"],
        "100%": ["margin closeout", "margin call threshold", "equity closeout"],
        "5 business days": ["complaints resolution", "complaint target"],
        "7 years": ["record retention", "minimum retention"],
    },
}
